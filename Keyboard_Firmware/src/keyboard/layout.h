...
// Otherwise, it needs KC_*
{
...

    {
        // right hand
        {
            ...
            {KC_H, KC_J, KC_K, KC_L, LT(MDIA, KC_SCLN), GUI_T(KC_QUOT), KC_LALT, CTL_T(KC_ESC)},
            {MEH_T(KC_NO), KC_N, KC_M, KC_COMM, KC_DOT, CTL_T(KC_SLSH), KC_RSFT, KC_PGUP},
            {KC_PGDN,KC_TAB, KC_ENT, KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB)}
        },
        {
