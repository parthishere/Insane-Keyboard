...
\subsection{Storage Sizing Based on Recharge Requirements}

\begin{itemize}
    \item Internal Resistance (RDS): 0.18 $\ohm$
    \item Capacity: 1.2 Ah
    \item C-rate: 0.2
    \item Discharge Current at 0.2C: 0.24 A
    \item Discharge Time at 0.2C: 5 hours
    \item Charge Cycles: 300
\end{itemize}

\textbf{Current Draw in Different Modes}
...
\textbf{Battery Performance Analysis}
The peak current requirement of 47.2 mA is significantly less than the battery's discharge current of 240 mA at 0.2C. This indicates that the battery can comfortably handle the peak current demands of the system.

\subsubsection{Tolerance Analysis}
\subsubsection{C-rate Verification}
\subsection{Maximum Discharge Rate Calculation}
